...
static const FlipperAppPluginDescriptor protopirate_about_plugin_descriptor = {
    .appid = PROTOPIRATE_ABOUT_PLUGIN_APP_ID,
    .ep_api_version = PROTOPIRATE_ABOUT_PLUGIN_API_VERSION,
    .entry_point = &protopirate_about_plugin,
};

const FlipperAppPluginDescriptor* protopirate_about_plugin_ep(void) {
    return &protopirate_about_plugin_descriptor;
}
